...
//        }
        ...
        public  String[] ShortText(String string){
            String key = "XuLiang"; // смешанный KEY перед генерацией пользовательской зашифрованной строки MD5
            String [] chars = new String [] {// Чтобы использовать символы, которые генерируют URL
                    "a","b","c","d","e","f","g","h",
                    "i","j","k","l","m","n","o","p",
                    "q","r","s","t","u","v","w","x",
                    "y","z","0","1","2","3","4","5",
